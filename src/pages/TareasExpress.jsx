        ...
        <div className="bg-gray-50 rounded-xl p-12 text-center">
          ...
          {isAdmin ? (
            ...
            <p className="text-gray-500">
              No hay tareas express registradas aún
            </p>
          )}
        </div>
      ) : (
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {tareasPendientes.map(tarea => (
                    <TareaExpressCard
                      key={tarea.id}
                      tarea={tarea}
                      onEdit={isAdmin ? handleEditTarea : null}
                      onDelete={isAdmin ? handleDeleteTarea : null}
                      onToggleComplete={isAdmin ? handleToggleComplete : null}
                      readOnly={!isAdmin}
                    />
                  ))}
                </div>
